...
export const BLOCK_FIELDS: Record<BlockType, FieldDef[]> = {
  ...
  liveStream: [
    ...
    { kind: "textarea", key: "description", label: "Description", rows: 2 },
    {
      ...
      key: "streamSlug",
      label: "Stream",
      hint: "Streams are managed under Live Streams, including HTML/Mist player embeds.",
    },
  ...
  embed: [
    ...
    { kind: "textarea", key: "description", label: "Description", rows: 2 },
    {
      ...
      key: "html",
      label: "Embed code",
      hint: "Paste an iframe or video tag. Scripts are stripped. For Mist / VideoStreamCanada players, create a Live Stream of type HTML embed instead.",
    },
