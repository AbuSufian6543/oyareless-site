...
export const BLOCK_FIELDS: Record<BlockType, FieldDef[]> = {
  ...
  liveStream: [
    ...
    { kind: "textarea", key: "description", label: "Description", rows: 2 },
    {
      ...
      key: "streamSlug",
      label: "Stream",
      hint: "Create the camera under Live Streams first. Paste the vendor embed there, set an optional password, then pick it here.",
    },
  ...
  streamGrid: [
    ...
    { kind: "boolean", key: "featuredOnly", label: "Only show featured listed streams" },
    {
      ...
      hint: "Leave all unchecked to show publicly listed streams. Check unlisted or password-protected streams to include them on this page.",
    },
  ],
  ...
  embed: [
    ...
    { kind: "textarea", key: "description", label: "Description", rows: 2 },
    {
      ...
      key: "html",
      label: "Embed code",
      hint: "Paste an iframe or video tag. Scripts are stripped, so Mist / VideoStreamCanada players will not run here. Use Live Streams (HTML embed) and a Live stream player section instead.",
    },
  ...
  mobileTrailer: [
    { kind: "text", key: "eyebrow", label: "Hero eyebrow" },
    { kind: "text", key: "headline", label: "Hero headline" },
    { kind: "text", key: "kicker", label: "Hero kicker" },
    { kind: "textarea", key: "subheadline", label: "Hero summary", rows: 3 },
    { kind: "image", key: "heroImageUrl", label: "Hero photo" },
    { kind: "text", key: "heroImageAlt", label: "Hero photo description" },
    {
      kind: "objectList",
      key: "callouts",
      label: "Hero callouts",
    ...
    { kind: "text", key: "quoteLabel", label: "Quote button label" },
    { kind: "text", key: "quoteHref", label: "Quote button link" },
    { kind: "text", key: "customLabel", label: "Custom-build button label" },
    { kind: "text", key: "customHref", label: "Custom-build button link" },
    {
      kind: "image",
      key: "flyerUrl",
      label: "Flyer file",
      hint: "JPG or PDF. Leave empty to use the flyer set under Branding.",
    },
    { kind: "text", key: "flyerLinkLabel", label: "Hero download link label" },
    { kind: "text", key: "stripText", label: "Lime strip text" },
    { kind: "text", key: "introEyebrow", label: "Intro eyebrow" },
    { kind: "text", key: "introHeading", label: "Intro heading" },
    { kind: "stringList", key: "introParagraphs", label: "Intro paragraphs", itemLabel: "Paragraph" },
    { kind: "text", key: "platformHeading", label: "Platform heading" },
    { kind: "stringList", key: "platformItems", label: "Platform points", itemLabel: "Point" },
    {
      kind: "objectList",
      key: "proof",
      label: "Proof cards",
      itemLabel: "Card",
      fields: [
        { kind: "text", key: "label", label: "Title" },
        { kind: "textarea", key: "detail", label: "Detail", rows: 2 },
      ],
    },
    { kind: "text", key: "pillarsHeading", label: "Specifications heading" },
    { kind: "textarea", key: "pillarsDescription", label: "Specifications intro", rows: 2 },
    {
      kind: "objectList",
      key: "pillars",
      label: "Specification columns",
      itemLabel: "Column",
      fields: [
        { kind: "text", key: "title", label: "Title" },
        { kind: "stringList", key: "items", label: "Items", itemLabel: "Item" },
      ],
    },
    { kind: "text", key: "towerEyebrow", label: "Tower eyebrow" },
    { kind: "text", key: "towerHeading", label: "Tower heading" },
    { kind: "textarea", key: "towerBody", label: "Tower copy", rows: 4 },
    { kind: "text", key: "towerBadge", label: "Tower photo badge" },
    { kind: "text", key: "towerStrip", label: "Tower strip" },
    { kind: "image", key: "towerImageUrl", label: "Tower photo" },
    { kind: "text", key: "towerImageAlt", label: "Tower photo description" },
    { kind: "text", key: "pipelineHeading", label: "Pipeline heading" },
    { kind: "textarea", key: "pipelineDescription", label: "Pipeline intro", rows: 3 },
    {
      kind: "objectList",
      key: "pipeline",
    ...
    { kind: "text", key: "applicationsHeading", label: "Applications heading" },
    { kind: "textarea", key: "applicationsDescription", label: "Applications intro", rows: 2 },
    {
      kind: "objectList",
      key: "applications",
    ...
    { kind: "text", key: "customEyebrow", label: "Custom-build eyebrow" },
    { kind: "text", key: "customHeading", label: "Custom-build heading" },
    { kind: "textarea", key: "customBody", label: "Custom-build copy", rows: 4 },
    { kind: "stringList", key: "customOptions", label: "Configurable options", itemLabel: "Option" },
    { kind: "stringList", key: "customTraits", label: "Traits", itemLabel: "Trait" },
    { kind: "text", key: "customCardHeading", label: "Quote card heading" },
    { kind: "textarea", key: "customCardBody", label: "Quote card copy", rows: 3 },
    { kind: "text", key: "customQuoteLabel", label: "Quote card button" },
    { kind: "text", key: "customQuoteHref", label: "Quote card link" },
    { kind: "text", key: "flyerHeading", label: "Flyer heading" },
    { kind: "textarea", key: "flyerDescription", label: "Flyer copy", rows: 3 },
    { kind: "text", key: "flyerButtonLabel", label: "Flyer button" },
    { kind: "text", key: "ctaHeading", label: "Closing heading" },
    { kind: "textarea", key: "ctaBody", label: "Closing copy", rows: 3 },
    { kind: "text", key: "ctaSecondaryLabel", label: "Closing secondary button" },
    { kind: "text", key: "ctaSecondaryHref", label: "Closing secondary link" },
  ],
};
