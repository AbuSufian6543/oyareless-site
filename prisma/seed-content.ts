  ...
  blocks: [
    {
      ...
      data: {
        ...
        height: "lg",
        buttons: [
          { label: "Explore our work", href: "#work", style: "primary", openInNewTab: false },
          { label: "Request a quote", href: "/request-quote", style: "outline", openInNewTab: false },
        ],
        highlights: [
          "Serving since 2005",
    ...
    {
      type: "capabilityGrid",
      settings: { background: "white", paddingY: "xl", anchor: "work" },
      data: {
        eyebrow: "What we put in",
        heading: "Three kinds of work. One provider.",
        description:
          "Most sites need the network, the building security, and a way to talk. Buying them from one team means they are designed to work together.",
        columns: "3",
        showImages: true,
        items: [
          {
            ...
            title: "Networks & IT",
            description:
              "Switching, routing, Wi-Fi, structured cabling, Microsoft 365, and next-generation firewalls we size, install, and support. Cisco, UniFi, Fortinet, Barracuda, Juniper and similar platforms we are trained on.",
            href: "/it-services",
          ...
          },
          {
            ...
            description:
              "IP video, intrusion panels, access control, and 24/7 monitoring where you contract it. One team owns the recorders and the network they sit on.",
          ...
          },
          {
            ...
            title: "Voice & radio",
            description:
              "VoIP for the office. Hytera DMR handhelds, mobiles, and repeaters as an authorized dealer — sales, rentals, and service.",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { value: "24/7", label: "Monitoring for contracted sites", suffix: "" },
          {
...
/**
 * Header and footer navigation. Canonical copy lives in nav-defaults so the
 * public fallback menu cannot drift behind seed.
 */
export { DEFAULT_NAV as SEED_NAV } from "../src/lib/nav-defaults";
