...
async function seedCatalogue(): Promise<void> {
  const brands = [
    ...
    },
    {
      ...
      logoUrl: vendorLogoUrl("sonicwall"),
      order: 8,
    },
    {
      slug: "watchguard",
      ...
      logoUrl: vendorLogoUrl("watchguard"),
      order: 9,
    },
    {
      slug: "palo-alto",
      ...
      logoUrl: vendorLogoUrl("palo-alto"),
      order: 10,
    },
    {
      slug: "sophos",
      name: "Sophos",
      category: "Firewall and endpoint security",
      description: "Sophos firewall and related security platforms we install and support.",
      logoUrl: vendorLogoUrl("sophos"),
      order: 23,
    },
    {
      slug: "butterflymx",
      name: "ButterflyMX",
      category: "Video intercom and access",
      description: "Video intercom and building access platforms we install and support.",
      logoUrl: vendorLogoUrl("butterflymx"),
      order: 24,
    },
    {
      slug: "fs",
      name: "FS",
      category: "Fiber and structured cabling",
      description: "Fiber and copper cabling products we use on structured cabling installs.",
      logoUrl: vendorLogoUrl("fs"),
      order: 25,
    },
    {
      slug: "oracle",
      name: "Oracle",
      category: "Cloud and applications",
      description: "Oracle platforms we connect to the office network and support.",
      logoUrl: vendorLogoUrl("oracle"),
      order: 26,
    },
    {
      slug: "uniview",
      name: "Uniview",
      category: "IP cameras and NVRs",
      description: "Uniview (UNV) cameras and recorders we install on surveillance systems.",
      logoUrl: vendorLogoUrl("uniview"),
      order: 27,
    },
    {
      slug: "schlage",
      name: "Schlage",
      category: "Electronic locks and access",
      description: "Schlage Engage and related electronic locks we install with building access.",
      logoUrl: vendorLogoUrl("schlage"),
      order: 28,
    },
    {
      slug: "shure",
      name: "Shure",
      category: "Pro audio and broadcast",
      description: "Microphones and audio we use on live events and broadcasts.",
      logoUrl: vendorLogoUrl("shure"),
      order: 29,
    },
    {
      slug: "cdvi",
